<div class="card card-body">
    <form method="post" id="filter" action="<?php echo base_url('recharge/RechargeController/insurance_commissionupdate'); ?>">
        <div class="form-row">
            <div class="row">
                 <div class="col-3">
                    <div class="form-group">
                                <label class="form-control-label">Service Provider</label>
                            <select name="operator" class="form-control" id="operater" value="">
            ...
            <div class="col-2">
              ...
              <input type="hidden" name="service_id" id="service_id" class='btn btn-primary' value="25"  required>
