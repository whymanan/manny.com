<div class="card card-body">
    <form method="post" id="filter" action="<?php echo base_url('recharge/RechargeController/landline_commissioninsert'); ?>">
        <div class="form-row">
            <div class="row">
                <div class="col-3">
                    <div class="form-group">
                            ...
                            <select name="operator" class="form-control valid" aria-invalid="false">
                                <option value="Airtel(LL)">Airtel(LL)</option>
                                <option value="BSNL - Corporate">BSNL - Corporate</option>
                                <option value="BSNL Individual(LL)">BSNL Individual(LL)</option>
                                <option value="MTNL - Delhi(LL)L">MTNL - Delhi(LL)</option>
                                <option value="MTNL - Mumbai(LL)">MTNL - Mumbai(LL)</option>
            ...
            <div class="col-2">
              ...
              <input type="hidden" name="service_id" id="service_id" class='btn btn-primary' value="21"  required>
