<div class="row">
    ...
    <div class="col-xl-12 ">
        <div class="card">
            ...
            <div class="card-body">
              <div class="pl-lg-6">
                  <!--<form method="post" id="filter" action="<?php echo base_url('dmt/insert'); ?>">-->
                  <div class="row">
                      <div class="col-lg-4">
...
<script>
  ...
  function Delete(id) {
    ...
    if (sureDel == true) {
      $.ajax({
        type: "GET",
        url: "<?php echo base_url('dmt/DmtController/delete/')?>" + id,
...
var $addCommissionForm = $('#addCommissionForm');
    ...
    if (sureDel == true) {
      $.ajax({
        type: "GET",
        url: "<?php echo base_url('dmt/DmtController/edit/') ?>" + id,
