                   ...
                   <div class="pl-lg-4">
                     <div class="row">
                         <div class="col-lg-6">
                             ...
                             <div class="form-group">
                               <button type="submit" class="btn btn-success" name="bank-select-confirm">Confirm</button>
                               <button type="reset" class="btn btn-primary" name="bank-select-confirm">Reset</button>
                             </div>
                         </div>
                         <div class="col-lg-6">
