                       ...
                       <div class="col-lg-6">
                         <div class="form-group">
                           ...
                           <div class="input-group input-group-merge">
                             ...
                             <input class="form-control" name="beneficiary_account_number" placeholder="Account Number" type="text" required>
                           </div>
                         </div>
                       </div>
                       <div class="col-lg-6">
                         <div class="form-group">
                           ...
                           <div class="input-group input-group-merge">
                             ...
                             <input class="form-control" name="beneficiary_ifsc" placeholder="Enter Ifsc Code" type="text" required>
                           </div>
                         </div>
                       </div>
                     </div>
