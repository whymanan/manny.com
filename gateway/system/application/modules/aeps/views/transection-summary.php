...
<?php endif; ?>
  ...
  <div class="card-body">
    ...
    <div class="display-2 ">Rs. <?php echo number_format($transaction->balance, 2) ?></div>
    <span class="">Transaction ID: <span class="text-dark"><?php echo $transaction->transection_id ?></span> </span>
    <span class="">Reference Number: <span class="text-dark"><?php echo $transaction->aepsTransaction->id->rrn ?></span></span>
            ...
            <table class="table mt-5 text-left">
              <tbody>
                <tr>
                  ...
                  <td class="px-0 ">
                    <?php echo $transaction->aepsTransaction->aadharno;  ?>
                  </td>
                  <td class="px-0 ">Bank Account</td>
                  <td class="px-0 ">
                    <?php echo  $transaction->aepsTransaction->invoiceNo;  ?>
                  </td>
