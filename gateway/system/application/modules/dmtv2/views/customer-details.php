      ...
      <li class="list-group-item px-0">
        <div class="row align-items-center">
          ...
          <div class="col-auto">
            ...
            <h4 class="display-5 mb-0"><?php echo $response->userName; ?></h4>
          </div>
          <div class="col-auto">
            <h5 class="mt-3 mb-0"> Customer Mobile </h5>
            <h4 class="display-5 mb-0"><?php echo $response->Mobile; ?></h4>
          </div>
          <div class="col-auto">
                  ...
                  <table class="table align-items-center">
                    ...
                    <tbody class="list">
                      <?php foreach ($beneficiarylist as $listData): ?>
                        <tr>
                          <td>
                            <?php echo $listData->beneficiaryId ?>
                          </td>
                          <td>
                            <?php echo $listData->AccountNumber ?>

                          </td>
                          <td>
                            <?php echo $listData->BeneficiaryName ?>

                          </td>
                          <td>
                            <?php echo $listData->IfscCode ?>

                          </td>
                          <?php if ($listData->AccountType == 'Active'): ?>
                            <td> <button type="button" class="btn btn-success btn-sm" name="button"> Make payment</button> </td>
                          <?php else: ?>
