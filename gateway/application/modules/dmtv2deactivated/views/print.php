<html>
    ...
    <body onload="window.print()">
        ...
        <img src="<?php echo base_url() ?>optimum/background1.jpg" width=612 height=792></div>
        ...
        <div style="position:absolute;left:243.30px;top:160.39px" class="cls_004"><span class="cls_004"><?php echo $result->transection_msg ?></span></div>
