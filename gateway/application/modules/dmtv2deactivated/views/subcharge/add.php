...
<form method="post" id="filter" action="<?php echo base_url('dmtv2/DmtvtwoController/add_surcharge'); ?>">
        ...
        <div class="form-row">
            <div class="row">
                <div class="col-2">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="start" placeholder="" required>
                    </div>
                </div>
                <div class="col-2">
                    <div class="form-group">
                ...
                <div class="col-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="charge"  placeholder="" required>
                    </div>
                </div>
                <div class="col-2">
                    <div class="form-group">
            ...
            <div class="col-2">
              ...
              <input type="hidden" name="service_id" id="service_id" class='btn btn-primary' value="7"  required>
