...
public function surcharge() {
  ...
  public function addCustomer() {
    ...
    public function customeradd($customer) {
      ...
      $url = 'https://emopay.co.in/vite/dmt/addCustomer';
      #guzzle
      try {
    ...
    public function addBeneficiary() {
     ...
     public function Beneficiaryadd($beneficiary) {
      ...
      $url = 'https://emopay.co.in/vite/dmt/addBeneficiary';
      #guzzle
      try {
          $response = $this->client->request('POST', $url, [
...
public function submitTransection() {
    ...
    if ($_POST) {
        ...
        if (isset($data['mobile']) && !empty($data['mobile'])) {
            ...
            if( $this->data['bal']>0 && $this->data['bal']>$data['amount']){
                ...
                $transection_id = "DMTnx".self::stan() ;
  ...
  public function dmtTForm() {
    ...
    if ($_GET) {
      ...
      if (isset($data['bId'])) {
        ...
        $url = 'https://emopay.co.in/vite/dmt/checkBeneficiary';
        #guzzle
        try {
             $response = $this->client->request('GET', $url, [
  ...
  public function transection_service() {
      ...
      $url = 'https://emopay.co.in/vite/dmt/directTransfer';
      #guzzle
      try {
          $response = $this->client->request('POST', $url, [
