    ...
    <div class="row">
        <div class="col-xl-4 order-xl-2">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-3 order-lg-2">
                        <div class="card-profile-image">
                            <a href="#">
                                <img src="<?php $link = "";
                                            if (!isset($docs[0]['name'])) {
                                                $link = '/assets/img/theme/avtar.png';
                                            } else {
                                                $link = 'uploads/photo/' . $docs[0]['name'];
                                            }
                                            echo base_url() . $link  ?>" class="rounded-circle">
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="container">
                        <h5 class="h3 mb-0">Adhaar Back Photo</h5>
                        <hr>
                        <?php if (isset($docs[1]['name'])) { ?>
                            <img src="<?php echo base_url() . 'uploads/'.$docs[1]['type'].'/' . $docs[1]['name'] ?>" alt="<?php echo $docs[3]['type'] ?>" width="90%">
                        <?php } else {
                            echo  '<h5 class="h3 mb-0">Adhaar Back Photo Not uploaded</h5>';
                        }
                        ?>
                    </div>
                    <hr>
                    ...
                    <div class="container">
                        ...
                        <hr>
                        <div class="container">
                            <?php if (isset($docs[2]['name'])) { ?>
                                <img src="<?php echo base_url() . 'uploads/'.$docs[2]['type'].'/' . $docs[2]['name'] ?>" alt="<?php echo $docs[3]['type'] ?>" width="90%">
                            <?php } else {
                                echo  '<h5 class="h3 mb-0">Adhaar Front Photo Not uploaded</h5>';
                            }
                            ?>
                        </div>
                    </div> <hr>
                    <div class="container">
                        ...
                        <hr>
                        <div class="container">
                            <?php if (isset($docs[3]['name'])) { ?>
                                <img src="<?php echo base_url() . 'uploads/'.$docs[3]['type'].'/' . $docs[3]['name'] ?>" alt="<?php echo $docs[3]['type'] ?>" width="90%">
                            <?php } else {
                                echo  '<h5 class="h3 mb-0">PAN Photo Not uploaded</h5>';
                            }
                            ?>
                        </div>
                    </div> <hr>
                    <div class="container">
                        ...
                        <hr>
                        <div class="container">
                            <?php if (isset($docs[4]['name'])) { ?>
                                <img src="<?php echo base_url() . 'uploads/'.$docs[4]['type'].'/'. $docs[4]['name'] ?>" alt="<?php echo $docs[3]['type'] ?>" width="90%">
                            <?php } else {
                                echo  '<h5 class="h3 mb-0">Passbook Photo Not uploaded</h5>';
                            }
                            ?>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer"> <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
