<div class="card card-body">
    <form method="post" id="filter" action="<?php echo base_url('recharge/RechargeController/challan_commissionupdate'); ?>">
        <div class="form-row">
            <div class="row">
                 <div class="col-3">
                    <div class="form-group">
                                    <label class="form-control-label">Service Provider</label>
                                      <select name="operator" id="operator" class="form-control select2 valid" aria-invalid="false">
                                            ...
                                            <option value="Andhra Pradesh Traffic Police">Andhra Pradesh Traffic Police</option>
                                        </select>
                                </div>
                </div>
                <div class="col-2">
            ...
            <div class="col-2">
              ...
              <input type="hidden" name="service_id" id="service_id" class='btn btn-primary' value="44"  required>
