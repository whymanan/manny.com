<div class="card card-body">
    <form method="post" id="filter" action="<?php echo base_url('recharge/RechargeController/loan_commissioninsert'); ?>">
        <div class="form-row">
            <div class="row">
                <div class="col-3">
            ...
            <div class="col-2">
              ...
              <input type="hidden" name="service_id" id="service_id" class='btn btn-primary' value="26"  required>
