...
<div class="row">
    ...
    <div class="col-xl-8 order-xl-2">
        <div class="card">
            ...
            <form id="upload" action="<?php echo base_url('/slideredit/'.$editslider[0]['id'])?>" enctype="multipart/form-data" method="post">
                    <input type="file" id="input-file-now" class="dropify" name="file" value="<?php if(isset($editslider[0]['slider'])){ echo base_url('assets/img/slide/'.$editslider[0]['slider']);}?>"/>
...
<script>
            $(document).ready(function(){
                ...
                $('.dropify').dropify(
                    {
                        defaultFile:'<?php echo base_url('assets/img/slide/'.$editslider[0]['slider']);?>',
