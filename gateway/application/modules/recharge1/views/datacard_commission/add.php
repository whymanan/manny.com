<div class="card card-body">
    <form method="post" id="filter" action="<?php echo base_url('recharge/RechargeController/datacard_commissioninsert'); ?>">
        <div class="form-row">
            <div class="row">
                <div class="col-3">
                    <div class="form-group">
                            ...
                            <select name="operator" class="form-control">
                                <option value="Jio Fi (Prepaid)">Jio Fi (Prepaid)</option>
                            </select>
                            </div>
                </div>
                <div class="col-2">
            ...
            <div class="col-2">
              ...
              <input type="hidden" name="service_id" id="service_id" class='btn btn-primary' value="14"  required>
