...
// Step 2 Add transection Details like Mobile number, Aadhar Number transection Type, transection Amount
 ...
 body.on('click', '#verify', function(event){
        ...
        var ifsc =$("#ifsc").val();
        if (typeof mobile !== 'undefined' && mobile  && typeof account !== 'undefined' && account && typeof ifsc !== 'undefined' && ifsc) {

          $.ajax({
            url: '<?php echo base_url('dmt/verify_account'); ?>',
            type: 'POST',
            data:{"mobile": mobile,'account' :account ,'ifsc' : ifsc ,"<?php echo $this->security->get_csrf_token_name(); ?>": "<?php echo $this->security->get_csrf_hash(); ?>"},
            ...
            alert("Please enter account, mobile, ifsc")
        }
