<div class="row">
    ...
    <div class="col-xl-12 order-xl-1">
         <div class="card">
          ...
          <div class="row">
            <div class="col-sm-6">
            <form action="<?php echo base_url('Gstfiling/gstfiling/saleReturn'); ?>" method="post" enctype="multipart/form-data">
            <div class="container">
            ...
            <div class="col-sm-6">
            <form  action="<?php echo base_url('Gstfiling/gstfiling/purchaseReturn'); ?>" method="post" enctype="multipart/form-data">
