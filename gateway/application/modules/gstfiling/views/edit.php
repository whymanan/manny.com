                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select name="vendor" id="vendor" class="form-control" required value="<?php echo $user->parent ?>">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="adharcard" class="form-control" required placeholder="xxxx-xxxx-xxxx-xxxx" value="<?php echo $details->aadhar ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="pancard" class="form-control uppercase" placeholder="xxxxx-xxxx-x" required value="<?php echo $details->pan ?>">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="organization_name" class="form-control" placeholder="XYZ pvt. ltd." value="<?php echo $details->organisation ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="gst_no" class="form-control uppercase" placeholder="xxxxx-xxxx-x" value="<?php echo $details->gstno ?>">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input name="address" class="form-control" required placeholder="Home Address" value="<?php echo $details->address ?>" type="text">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="pincode" class="form-control" placeholder="Postal code" required value="<?php echo $details->pincode ?>">
                                </div>
                            </div>
                        </div>
                    </div>
