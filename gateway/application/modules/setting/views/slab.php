<div class="row">
    ...
    <div class="col-xl-4 order-xl-1">
        <div class="card">
            ...
            <div class="card-body">
                <form name="validate" role="form" action="<?php echo base_url('slab/submit'); ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                    <h4 class="heading-small text-muted mb-4">Slab</h4>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label class="form-control-label">Slab</label>
                                <input type="text" name="start" id="slab" class="form-control clear" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input type="number" name="end" id="rate" class="form-control clear" required>
                            </div>
                        </div>
                    </div>
...
<script>
    function Delete(id) {
        ...
        if (sureDel == true) {
            $.ajax({
                type: "GET",
                url: "<?php echo base_url() ?>setting/slab/delete/" + id,
    ...
    $(document).ready(function() {
        $("#update_btn").on('click', function() {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url('setting/slab/update') ?>",
                data: {
                    'form': form,
        ...
        var Api = '<?php echo base_url('setting/slab/'); ?>';
    ...
    function Edit(id) {
        ...
        if (sureDel == true) {
            $.ajax({
                type: "GET",
                url: "<?php echo base_url() ?>setting/slab/edit/" + id,
                ...
                success: function(response) {
                    ...
                    if (response != "") {
                        ...
                        $('#slab').val(response.start);
                        $('#slab_id').val(response.slab_id);

                        $('#rate').val(response.end);
                    } else {
                        Swal.fire({
                            position: 'top-end',
                            type: 'error',
