...
function CaptureAvdm(PrimaryUrl) {
  ...
  var XML = '<PidOptions ver="1.0"> <Opts fCount="1" fType="0" iCount="0" pCount="0" pgCount="2" format="0"   pidVer="2.0" timeout="10000" pTimeout="20000" posh="UNKNOWN" env="P" /> <CustOpts><Param name="mantrakey" value="" /></CustOpts> </PidOptions>';
  $.ajax({
    type: "CAPTURE",
    async: false,
    crossDomain: true,
